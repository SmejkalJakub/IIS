...
<div class="container bg-white rounded mt-5 p-4">
    ...
    <div class="mt-3 form-group @if($errors->has('task')) has-error @endif">
        ...
        {!! Form::textarea('task', null, ['class' => 'form-control', 'placeholder' => 'Enter task']) !!}
        @if ($errors->has('task'))
    ...
    <div class="custom-file mb-3" style="max-width: 600px">
        ...
        <div class="form-group @if($errors->has('right_answer')) has-error @endif">
            <div id="openAnswer">
                ...
                {!! Form::textarea('right_answer', null, ['class' => 'form-control', 'placeholder' => 'Enter right answer']) !!}
            ...
            <div id="closedAnswer">
                ...
                <div class="input-group mb-3 @if($errors->has('option_1')) has-error @endif">
                    ...
                    {!! Form::text('option_1', null, ['class' => 'form-control', 'placeholder' => 'A)', 'maxlength'=>512]) !!}
                ...
                <div class="input-group mb-3 @if($errors->has('option_1')) has-error @endif">
                    ...
                    {!! Form::text('option_2', null, ['class' => 'form-control', 'placeholder' => 'B)', 'maxlength'=>512]) !!}
                ...
                <div class="input-group mb-3 @if($errors->has('option_3')) has-error @endif">
                    ...
                    {!! Form::text('option_3', null, ['class' => 'form-control', 'placeholder' => 'C)', 'maxlength'=>512]) !!}
                ...
                <div class="input-group @if($errors->has('option_4')) has-error @endif">
                    ...
                    {!! Form::text('option_4', null, ['class' => 'form-control', 'placeholder' => 'D)', 'maxlength'=>512]) !!}
